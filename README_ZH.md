...
> 状态（Phase 2）：脚手架、NPU runtime smoke test、safetensors loader、`tokenizers-cpp` wrapper、
> baseline public-aclnn ops，以及 cube matmul / RMSNorm / SwiGLU / attention-step 的 custom_opp scaffold 已完成。
> Decoder layer 和完整 LM 会在 Phase 3+ 落地。
