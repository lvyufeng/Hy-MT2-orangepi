...
> 状态（Phase 3）：脚手架、NPU runtime smoke test、safetensors loader、`tokenizers-cpp` wrapper、
> baseline public-aclnn ops、custom_opp scaffold、Hy-MT2 decoder layer，以及 32 层 tied-embedding
> language-model loop 已完成。Translator CLI 会在 Phase 4 落地。
