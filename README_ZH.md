...
> 状态（Phase 4）：脚手架、NPU runtime smoke test、safetensors loader、`tokenizers-cpp` wrapper、
> baseline public-aclnn ops、custom_opp scaffold、Hy-MT2 decoder layer、32 层 tied-embedding
> language-model loop、`libhy_mt2.so`、`Translator` 和 `hy_mt2_translate` 已完成。Phase 5 进入 benchmark / 性能优化。
