#include "rms_norm2048_custom_tiling.h"
#include "register/op_def_registry.h"

namespace optiling {
static ge::graphStatus TilingFunc(gert::TilingContext* context) {
    RmsNorm2048CustomTilingData tiling;
...
namespace ops {
class RmsNorm2048Custom : public OpDef {
public:
    explicit RmsNorm2048Custom(const char* name) : OpDef(name) {
        this->Input("x")
            .ParamType(REQUIRED)
